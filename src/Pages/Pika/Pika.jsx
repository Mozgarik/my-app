    ...
    return(
        <div>
             ...
             <div className={s.opys}>
                 ...
                 Ви поїхали в колоритне місто, щоб втекти від сірих буднів і провести час на природі. Ви залишили свої речі в готелі та вирушили на лісову стежку, незважаючи на попередження господині. 
                 У результаті ви звернули не туди і заблукали в лісі під час грози і вже темряви. Щоб знайти укриття, ви зупинилися в покинутій хатині.
                  Відчувши себе в безпеці, ви вирішили зайти всередину, але двері зачинилися за вами, і ви опинилися замкнені в цьому місці. Тепер вам доведеться дізнатися легенду Пікової дами, пов'язаної з цим будинком, або ж загинути в цьому покинутому місці.
                 </span>
                 </div>
             <div className={s.questAdress}>
                 ...
                 <ul className={s.questContactList}>
                     ...
                     <li className={s.questContactItem}>Адреса: <span className={s.contactDesc}> Одеса, вул. Асташкіна 1</span> </li>
