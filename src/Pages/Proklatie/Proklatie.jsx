       ...
       <div>
            ...
            <div className={s.opys}>
                ...
                <span className={s.questHist}>
                    Ви вирушаєте в абатство Сент-Карта разом зі священиком Бруком і молодою послушницею Айрін, щоб розслідувати загадковий інцидент із черницею та стародавньою реліквією.
                    Вам доведеться зіткнутися зі злом, яке набуло вигляду демонічної черниці і готове на все, щоб захопити ваші душі. Ви повинні бути готові до небезпеки, ризикуючи своїм життям, вірою та душею.
                    Ваше завдання - зупинити злісну силу, перш ніж вона завдасть ще більшої шкоди.
                </span>
                </div>
            <div className={s.questAdress}>
                ...
                <ul className={s.questContactList}>
                    ...
                    <li className={s.questContactItem}>Адреса: <span className={s.contactDesc}>вул. Гоголя 1/3, перший під’їзд, код 2к , район Приморський</span> </li>
                    <li className={s.questContactItem}>Номер телефону: <span className={s.contactDesc}>+380 99 516 91 66</span></li>
                </ul>
            </div>
            </div>
